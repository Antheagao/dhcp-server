...
def main():
	...
	while 1:
		...
		ip_index += 1
		used_ip.append(ip_list[ip_index])
		current_ip = ip_list[ip_index]
		...
		msg = dhcp_offer(xid, hardware_address, current_ip)
		xid = []
		hardware_address = []
		...
		msg = dhcp_ack(xid, hardware_address, current_ip)
		xid = []
		hardware_address = []
...
def dhcp_offer(xid, hardware_address, current_ip):
...
def dhcp_ack(xid, hardware_address, current_ip):
